function CMenu(){
    ...
    this._init = function(){
        ...
        if(DISABLE_SOUND_MOBILE === false || s_bMobile === false){
            _pStartPosDeleteSave = {x: CANVAS_WIDTH - (oSprite.height*1.5)- 5, y: (oSprite.height/2) + 10};
        }else{
            _pStartPosDeleteSave = {x: CANVAS_WIDTH - (oSprite.width/2)- 10, y: (oSprite.height/2) + 10};
        }
